...
use methods::{HASH_ID, HASH_PATH, MULTIPLY_ID, MULTIPLY_PATH, HeaderMinusHash, HeaderMinusNonce};
...
fn main(){
    ...
    if args.len() == 1{
        println!("1 Argument needed. BITCOIN-MINING-HASH or MULTIPLY");
        return
    }
